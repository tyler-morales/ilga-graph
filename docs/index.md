...
- [**Campaign finance (SBE money layer)**](features/campaign-finance.md) — Committees + Receipts ingest, member matching, unmatched review / gold overrides, `memberMoneyTrail` / `billMoneyContext`.
