...
| **Money intel waitlist** | `money_intel_leads` | POST `/intelligence/money/signup` (public, CSRF + rate limit). Single-opt. Export: GET `/admin/money-leads.csv` or sqlite3. See [Money intel signup](../features/money-intel-signup.md). |
